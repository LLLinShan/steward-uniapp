<template>
  <view class="page">
    ...
    <div class="page-button">
      <u-button type="primary" :ripple="true" @click="toAddHouse">新增住户</u-button>
    </div>
  </view>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      tabs: [{ name: '即将到期' }, { name: '已到期' }],
      type: 2, //查询类型（1：到期住户；2：即将到期）
      curTab: 0,
  ...
  methods: {
    ...
    toSearchHouse() {
      uni.navigateTo({
        url: '/pages/home/manage/searchHouse'
      })
    },
    // 回到首页
    toHome() {
    ...
    toSearchPerson() {
      uni.navigateTo({
        url: '/pages/home/manage/searchPerson'
      })
    }
  }
}
